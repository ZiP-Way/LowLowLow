...
namespace UI.RateUs {
    public class RateUsScreen : MonoBehaviour {
        ...
        private readonly Signal<int> _starButtonPressed = new Signal<int>();
        ...
        private void Awake() {
            ...
            _starButtonPressed.Subscribe(OnStarButtonPressed).AddTo(this);
            _rateBtn.onClick.AddListener(OnRatePressed);
            _cancelBtn.onClick.AddListener(OnCancelPressed);

            Hub.ShowRateUs.Subscribe(OnShowRequest).AddTo(this);
