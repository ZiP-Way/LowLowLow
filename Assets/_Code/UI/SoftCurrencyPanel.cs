...
namespace UI
{
    ...
    public class SoftCurrencyPanel : MonoBehaviour, IUpdatable
    {
        ...
        /// </summary>
        public readonly Signal AnimationComplete = new Signal();
        ...
        private void Awake()
        {
            ...
            Hub.ForceRefreshSoftCurrency.Subscribe(x => SetValue(PlayerProfile.SoftCurrency)).AddTo(this);
        ...
        private void SubscribeToValueChange()
        {
            ...
            if (_sub != null) return;
            _sub = Hub.SoftCurrencyChanged.Subscribe(SetValue).AddTo(this);
        }
